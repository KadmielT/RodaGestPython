"""
Django settings for rodagest project.
...
SECRET_KEY = 'django-insecure-s!ss+xx1#p#!yue8_*k9vvb%r%$j8y+1t-a@ddr#3yzvgxpvya'
...
MIDDLEWARE = [
    ...
    'apps.usuarios.middleware.RodaGestPermissaoMiddleware',
    'django.middleware.clickjacking.XFrameOptionsMiddleware',
]

ROOT_URLCONF = 'rodagest.urls'
...
WSGI_APPLICATION = 'rodagest.wsgi.application'
