...
from .models import Servico, ItemServicoRoda, ItemServicoInsumo, ImagemServico
...
class ItemServicoRodaForm(forms.ModelForm):
    class Meta:
        model = ItemServicoRoda
...
class ItemServicoInsumoForm(forms.ModelForm):
    class Meta:
        model = ItemServicoInsumo
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields['insumo'].queryset = self.fields['insumo'].queryset.order_by('nome')


class ItemServicoRodaInlineForm(forms.Form):
...
class ItemServicoInsumoInlineForm(forms.Form):
